    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-6">
        ...
        >
          ...
          <button className="mt-8 rounded-md border border-transparent bg-black px-4 py-2 font-medium text-white shadow-sm hover:bg-[#050708]/80 focus:outline-none focus:ring-2 focus:ring-[#050708] focus:ring-offset-2 ">
            로그인
          </button>
        </form>
      </div>
